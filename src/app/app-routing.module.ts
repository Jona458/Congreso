...
const routes: Routes = [
  ...
  {
    path: 'pagina1',
    loadChildren: () => import('./pagina1/pagina1.module').then( m => m.Pagina1PageModule),canActivate: [AuthGuard]
  },
  {
    path: 'pagina2',
    loadChildren: () => import('./pagina2/pagina2.module').then( m => m.Pagina2PageModule),canActivate: [AuthGuard]
  },
  {
    path: 'pagina3',
  ...
  {
    path: 'pagina4',
    loadChildren: () => import('./pagina4/pagina4.module').then( m => m.Pagina4PageModule),canActivate: [AuthGuard]
  },
  {
    path: 'pagina5',
    loadChildren: () => import('./pagina5/pagina5.module').then( m => m.Pagina5PageModule),canActivate: [AuthGuard]
  },
  {
